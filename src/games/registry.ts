...
export const GAMES: GameDef[] = [
  ...
  { id: 'sudoku', nameKey: 'games.sudoku.name', taglineKey: 'games.sudoku.tagline', route: '/play/sudoku', category: 'must-have', emoji: '🔢', gradient: 'from-sky-500 to-indigo-600', available: false },
  ...
  { id: 'gomoku', nameKey: 'games.gomoku.name', taglineKey: 'games.gomoku.tagline', route: '/play/gomoku', category: 'must-have', emoji: '⚫', gradient: 'from-amber-500 to-orange-600', available: false },
